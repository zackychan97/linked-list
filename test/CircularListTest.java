...
class CircularListTest {
    ...
    @Test
    void checkIfCircularForward(){
        ll.insertFront(10);
        ll.insertFront(20);
        assertEquals(true, ll.isCircularForward());
    }

    @Test
    void checkIfCircularBackward(){
        ll.insertFront(10);
        ll.insertFront(20);
        assertEquals(true, ll.isCircularBackward());
    }
